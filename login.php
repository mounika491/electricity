...
<body>
    <div class="login-box">
        ...
        <div class="task1-box">
            <h4>Task 1 Implementation</h4>
            <p>For Task 1 specific billing with slab rates:</p>
            <a href="generate_bill_task1.php">🧾 Generate Bill (Task 1 Rates)</a>
            <p style="margin-top: 10px; font-size: 12px; color: #666;">
                Implements all Task 1 requirements including validation, slab rates, and fine calculation
            </p>
        </div>
